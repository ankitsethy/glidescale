    ...
    <section id="home" ref={ref} className="relative min-h-[100vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-navy-950">
      ...
      >
        ...
        <motion.div 
          ...
          className="mb-8"
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-electric-500/20 bg-electric-500/5 backdrop-blur-sm shadow-[0_0_15px_rgba(99,102,241,0.1)]">
             <div className="w-1.5 h-1.5 rounded-full bg-electric-400 animate-pulse"></div>
             <span className="text-[11px] font-bold text-electric-300 uppercase tracking-[0.2em]">System Architecture v2.0</span>
          </div>
        </motion.div>
